...
public class SeparatorCWriter {
    ...
    public SeparatorCWriter (File outFile, List<Method> separatedMethod,int whichSDK) {
        mOutFile = outFile;
    ...
    public void write() throws IOException {
        try (BufferedWriter fileWriter = new BufferedWriter(new FileWriter(mOutFile))) {
            ...
            for (Method method : mSeparatedMethod) {
                String definingClass = method.getDefiningClass();//获取方法的定义类
...
//        fileWriter.newLine();
        ...
        sb.append("jvalue result = NISLvmInterpretPortable(gAdvmp.ycFile,");
        sb.append(index);
        sb.append(" , env, thiz");
        ...
        sb.delete(0, sb.length());
        sb.append("return ");
        System.out.println("the native method teturn type is " +method.getReturnType());
