...
public class AndroidManifestHelper {
    ...
    public static TypeDescription findFirstClass(File manifestFile,String InputProtectClassName) throws IOException {
                                                                    ...
                                                                    public void attr(String ns, String name, int resourceId, int type, Object obj) {
                                                                        if (R.attr.name == resourceId
                                                                            ...
                                                                            if (componentName.equals("android.intent.action.MAIN")) {
                                                                                className[0] = InputProtectClassName;//判断进入MainActivity主类，但赋值时候却赋给别的Activity实现保护。
...
//        TypeDescription classDesc000 = TypeDescriptionHelper.convertByFullClassName(className[0]);
